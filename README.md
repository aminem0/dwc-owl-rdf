...
- **Luna AMI trap**: A dataset of AI identified moths from an autonomous moth or insect trap set up in Vermont. The data were obtained by connecting to the demo API in [the official webpage](https://demo.antenna.insectai.org/projects).
