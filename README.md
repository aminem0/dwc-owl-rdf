...
- **Dataset organization**: The dataset does not exist as a static archive or packaged file. Instead, the data is exposed through a Django REST API against which requests can be made. The API provides several endpoints, including those for events and occurrences.
